...
<template>
    <div class="overflow-x-hidden">
        <div :style="bannerStyle" class="bg-cover bg-no-repeat bg-center w-full h-[90vh] md:h-[120vh] relative">
        ...
        <div class="w-full bg-[#203D4D] p-[20px] md:p-[40px] lg:p-[64px] md:pb-[120px]">
            <hr class="w-full border border-[#fff]">
            <div class="w-full flex flex-col md:flex-row items-start gap-[24px] mt-[56px] md:mt-[120px]">
                <div class="flex items-center gap-[10px] md:gap-[20px] w-[35%]">
                ...
                <div class="md:w-[50%]">
                    <div class="text-[#EDF3F3] text-[32px] md:text-[48px] font-light leading-[36px] md:leading-[58px] font-light">
        ...
        <div class="w-full bg-[#203D4D] p-[20px] md:p-[40px] lg:p-[64px] md:py-[120px]">
            <div class="w-full flex items-start gap-[24px] mt-[20px] md:mt-[120px] flex-nowrap">
                <div class="w-[35%] h-[20%]">
            ...
            <div class="hidden md:inline-block w-full flex items-start mt-[64px]">
                <div class="w-[35%]"></div>
            ...
            <div class="w-full flex items-start mt-[40px] md:mt-[100px]">
                <div class="hidden md:blcok w-[35%]"></div>
                <div class="md:w-[50%] text-[#EDF3F3] text-[32px] md:text-[48px] font-light leading-[36px] md:leading-[58px]">
                    Our partners, business associates, and health advocates share our vision and help make OKEARA
                    Community stronger.
                </div>
            </div>
            <div class="mt-[40px] md:mt-[80px] w-full flex flex-col md:flex-row items-start">
                <div class="hidden md:block w-[35%]"></div>
                <div class="w-[90%] ml-[10%] md:ml-0 md:w-[65%] flex flex-col md:flex-row items-start gap-[50px]">
                    <div class="text-[#EDF3F3] text-[16px] md:text-[18px] leading-[24px] opacity-80">
                        ...
                        wellness enthusiasts can thrive. Our partnerships are founded on shared values and goals. Health
                        advocates inspire us with their passion and knowledge about well-being.
                    </div>
                    <div class="text-[#EDF3F3] text-[16px] md:text-[18px] leading-[24px] opacity-80">
                        Our business associates bring new ideas and products that fit into our personalized approach,
                        helping us grow and improve continuously. Together, we build a strong, supportive, and evolving
                        network.
                    </div>
                </div>
            </div>
        </div>
        <div :style="sectionBlcokStyle" class="bg-cover bg-no-repeat bg-center w-full h-screen" />
        <div class="w-full bg-[#EDF3F3] p-[20px] md:p-[40px] lg:p-[174px]">
            <div class="w-full flex items-start gap-[15%]">
                <img :src="CommunityStructured1" alt="Community 1" class="w-[45%]">
                <img :src="CommunityStructured2" alt="Community 2" class="w-[30%] mt-[10%]">
            </div>
            <div class="w-[70%] mx-auto md:mx-0 md:w-full flex flex-col md:flex-row items-start justify-between mt-[64px] md:mt-[120px]">
                <div class="text-[#274A5C] text-[32px] md:text-[48px] font-light leading-[36px] md:leading-[58px] md:w-[50%]">
                    OKEARA structured hydrogen water shows our commitment to Wellness and Community.
                </div>
                <div class="text-[#274A5C] text-[16px] md:text-[18px] leading-[26px] md:w-[40%] opacity-77 mt-[40px] md:mt-[120px]">
