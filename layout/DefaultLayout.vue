<template>
    <div>
        ...
        <slot />
        <FooterComponents />
        <ModalRegion :show="isModalOpen" @close="isModalOpen = false" />
    </div>
</template>
...
provide('openModal', () => (isModalOpen.value = true))
provide('closeModal', () => (isModalOpen.value = false))
provide('companyId', companyId)
provide('companyCode', companyCode)
