...
<template>
    <div
        ...
        <div
            ...
            <div class="text-white text-[16px] md:text-[18px] font-light leading-[24px]" style="text-edge: cap;">© 2025
                OKEARA. All Rights Reserved</div>
            <div
                ...
                <div class="hidden md:inline">|</div> <span>Privacy Policy</span>
            </div>
        </div>
    </div>
</template>
